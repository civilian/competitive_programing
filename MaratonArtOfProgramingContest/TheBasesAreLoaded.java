...
//		input=new BufferedReader(new InputStreamReader(System.in));
		input=new BufferedReader(new FileReader("TheBasesAreLoaded"));
		...
		for (int casesId = 1;; casesId++) {
			...
			try {
				...
				System.out.println(numero+" is an illegal base "+iBaseOrigi);
				continue;
			}
			...
			System.out.println(numero+" base "+iBaseOrigi+" = "+sNumeroEnBase2+" base "+iBase2);
