...
class ch2_05_TreeMap_TreeSet {
	public static void main(String[] args) {
		...
		TreeSet<Integer> used_values = new TreeSet<Integer>(); // must use
																// TreeSet as
																// Set is an
																// abstract
																// class
		used_values.clear();
		TreeMap<String, Integer> mapper = new TreeMap<String, Integer>(); // must
																			// use
																			// TreeMap
																			// as
																			// Map
		...
		System.out.println(used_values.headSet(77)); // returns [69, 75] (these
														// two are before 77 in
														// the inorder traversal
														// of this BST)
		System.out.println(used_values.tailSet(77)); // returns [77, 78, 80, 81,
														// 82] (these five are
														// equal or after 77 in
														// the inorder traversal
														// of this BST)
