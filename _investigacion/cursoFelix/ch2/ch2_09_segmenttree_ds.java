/*es un arbol que permite buscar el minimo en un intervalo (RMQ) en log(n) y que 
 * se llena en nlog(n)*/
/*Solo guarda el menor en el intervalo y funciona como un heap*/
/*Para cambiar a maximo se cambia todo lo que sea < por >, menos lo de fuera de rango*/
